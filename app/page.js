...
export default function Home() {
  ...
  useEffect(() => {
    setMessages([
      {
        role: 'assistant',
        content: "👋 Hi there! I'm Headstart Bot, your AI assistant. I'm here to help you with any questions, tasks, or just to chat! What can I help you with today?"
      }
    ]);
  }, []);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-gray-900">Headstart Bot</h1>
              ...
              <div className="flex justify-start">
                <div className="bg-gray-100 text-gray-900 rounded-lg px-4 py-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">Headstart Bot is thinking...</span>
                  </div>
                </div>
              </div>
            )}
